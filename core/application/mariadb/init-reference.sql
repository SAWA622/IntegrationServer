...
CREATE DATABASE IF NOT EXISTS accessManagerDb;
CREATE USER IF NOT EXISTS 'TeisAmAdmin'@'%' IDENTIFIED BY 't5!SA%c@Mr';
GRANT ALL PRIVILEGES ON accessManagerDb.* TO 'TeisAmAdmin'@'%';
FLUSH PRIVILEGES;
